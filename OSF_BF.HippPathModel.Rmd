...
source('OSF_BF.HippPathModel_setup.R')
library(knitr)
...
<!-- ## SR -->
<!-- #age -->
```{r SR_age_cor, echo=FALSE, include=FALSE}
cebq_SR_age_cor.test
```

<!-- #TIV -->
```{r SR_TIV_cor, echo=FALSE, include=FALSE}
cebq_SR_TIV_cor.test
```

<!-- #sex -->
```{r SR_sex_ttest, echo=FALSE, include=FALSE}
cebq_SR_sex_t.test
```

<!-- # maternal education -->
```{r SR_mEd_anova, echo=FALSE, include=FALSE}
cebq_SR_mEducation_anova
```

<!-- # Income -->
```{r SR_incom_anova, echo=FALSE, include=FALSE}
...
<!-- #premature -->
```{r SR_premat_ttest, echo=FALSE, include=FALSE}
cebq_SR_premat_t.test
```

<!-- ##BMI:p85BMI -->
<!-- #age -->
```{r BMIp85BMI_age_cor, echo=FALSE, include=FALSE}
BMIp85BMI_age_cor.test
```

<!-- #TIV -->
```{r BMIp85BMI_TIV_cor, echo=FALSE, include=FALSE}
BMIp85BMI_TIV_cor.test
```

<!-- #sex -->
```{r BMIp85BMI_sex_ttest, echo=FALSE, include=FALSE}
BMIp85BMI_sex_t.test
```

<!-- # maternal education -->
```{r BMIp85BMI_mEd_anova, echo=FALSE, include=FALSE}
...
<!-- # Income -->
```{r BMIp85BMI_incom_anova, echo=FALSE, include=FALSE}
BMIp85BMI_income_anova
```

<!-- #premature -->
```{r BMIp85BMI_premat_ttest, echo=FALSE, include=FALSE}
BMIp85BMI_premat_t.test
```

<!-- ##Left Hippocampus -->
<!-- #age -->
```{r lHip_age_cor, echo=FALSE, include=FALSE}
lHip_age_cor.test
```

<!-- #TIV -->
```{r lHip_TIV_cor, echo=FALSE, include=FALSE}
lHip_TIV_cor.test
```

<!-- #sex -->
```{r lHip_sex_ttest, echo=FALSE, include=FALSE}
lHip_sex_t.test
```

<!-- # maternal education -->
```{r lHip_mEd_anova, echo=FALSE, include=FALSE}
lHip_mEducation_anova
```

<!-- # Income -->
```{r lHip_incom_anova, echo=FALSE, include=FALSE}
lHip_income_anova
...
<!-- #premature -->
```{r lHip_premat_ttest, echo=FALSE, include=FALSE}
lHip_premat_t.test
```

<!-- ## Right Hippocampus  -->
<!-- #age -->
```{r rHip_age_cor, echo=FALSE, include=FALSE}
rHip_age_cor.test
```

<!-- #TIV -->
```{r rHip_TIV_cor, echo=FALSE, include=FALSE}
rHip_TIV_cor.test
```

<!-- #sex -->
```{r rHip_sex_ttest, echo=FALSE, include=FALSE}
rHip_sex_t.test
```

<!-- # maternal education -->
```{r rHip_mEd_anova, echo=FALSE, include=FALSE}
rHip_mEducation_anova
```

<!-- # Income -->
```{r rHip_incom_anova, echo=FALSE, include=FALSE}
rHip_income_anova
...
<!-- #premature -->
```{r rHip_premat_ttest, echo=FALSE, include=FALSE}
rHip_premat_t.test
```
...
kable(HippL_pathmod_summary$PE[c(1:21, 53:54), c(1:3, 6:9)], digits = 3, caption = "Parameters for Model: BF -> SR (L Hipp Med) -> p85th BMI", booktabs=TRUE)
```
\FloatBarrier
...
## 3.2.1 Path Model for Left Hippocampus: Direct Effect of Breastfeeding
\FloatBarrier
...
kable(HippL_dirBF_pathmod_summary$PE[c(1:22), c(1:3, 6:9)], digits = 3, caption = "Parameters for Sensitivity Test: direct effect of breastfeeding on p85 BMI", booktabs=TRUE)
```
\FloatBarrier

\clearpage

## 3.2.1 Path Model for Left Hippocampus: Sensitivit test with individual characteristics
\FloatBarrier


```{r HippL_pathmod_SensTest_HipAssoc_fit, echo=FALSE, results='asis'}
kable(HippL_SensitivityTest_summary$FIT[c(3:11, 16:21)], digits = 3, caption = "Fit Statistics for Sensitivity Test: individual characteristics associated with Hipp", booktabs=TRUE) 
```
\FloatBarrier

```{r HippL_pathmod_SensTest_HipAssoc_PE, echo=FALSE, results='asis'}
kable(HippL_SensitivityTest_summary$PE[c(1:24), c(1:3, 6:9)], digits = 3, caption = "Parameters for Sensitivity Test: individual characteristics associated with Hipp", booktabs=TRUE)
```
\FloatBarrier
...
kable(HippR_pathmod_summary$PE[c(1:21, 53:54), c(1:3, 6:9)], digits = 3, caption = "Parameters for Model: BF -> SR (R Hipp Med) -> p85th BMI", booktabs=TRUE) 
```
...
## 3.2.1 Path Model for Right Hippocampus: Direct Effect of Breastfeeding
\FloatBarrier
...
kable(HippR_dirBF_pathmod_summary$PE[c(1:22), c(1:3, 6:9)], digits = 3, caption = "Parameters for Sensitivity Test: direct effect of breastfeeding on p85 BMI", booktabs=TRUE)
```
\FloatBarrier
## 3.2.1 Path Model for Right Hippocampus: Sensitivit test with individual characteristics

\FloatBarrier

```{r HippR_pathmod_SensTest_HipAssoc_fit, echo=FALSE, results='asis'}
kable(HippR_SensitivityTest_summary$FIT[c(3:11, 16:21)], digits = 3, caption = "Fit Statistics for Sensitivity Test: individual characteristics associated with Hipp", booktabs=TRUE)
```
\FloatBarrier

```{r HippR_pathmod_SensTest_HipAssoc_PE, echo=FALSE, results='asis'}
kable(HippR_SensitivityTest_summary$PE[c(1:29), c(1:3, 6:9)], digits = 3, caption = "Parameters for Sensitivity Test: individual characteristics associated with Hipp", booktabs=TRUE) 
```