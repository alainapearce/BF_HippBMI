...
kable(HippL_pathmod_summary$PE[c(1:35), c(1:3, 6:9)], digits = 3, caption = "Parameters for Model: BF -> SR (L Hipp Med) -> p85th BMI", booktabs=TRUE)
```
\FloatBarrier
...
```{r HippL_pathmod_SensTest_fit, echo=FALSE, results='asis'}
kable(HippL_SensitivityTest_summary$FIT[c(3:11, 16:21)], digits = 3, caption = "Fit Statistics for Model: BF -> SR (L Hipp Med) -> p85th BMI", booktabs=TRUE) 
```
\FloatBarrier

```{r HippL_pathmod_SensTest_PE, echo=FALSE, results='asis'}
kable(HippL_SensitivityTest_summary$PE[c(1:35), c(1:3, 6:9)], digits = 3, caption = "Parameters for Model: BF -> SR (L Hipp Med) -> p85th BMI", booktabs=TRUE)
```
\FloatBarrier
...
kable(HippR_pathmod_summary$PE[c(1:35), c(1:3, 6:9)], digits = 3, caption = "Parameters for Model: BF -> SR (R Hipp Med) -> p85th BMI", booktabs=TRUE) 
```
...
```{r HippR_pathmod_SensTest_fit, echo=FALSE, results='asis'}
kable(HippR_SensitivityTest_summary$FIT[c(3:11, 16:21)], digits = 3, caption = "Fit Statistics for Model: BF -> SR (R Hipp Med) -> p85th BMI", booktabs=TRUE)
```
\FloatBarrier

```{r HippR_pathmod_SensTest_PE, echo=FALSE, results='asis'}
kable(HippR_SensitivityTest_summary$PE[c(1:35), c(1:3, 6:9)], digits = 3, caption = "Parameters for Model: BF -> SR (R Hipp Med) -> p85th BMI", booktabs=TRUE) 
```